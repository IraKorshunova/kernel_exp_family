...
if theano_available:
    ...
    gaussian_kernel_hessian_theano = function(inputs=[x, y, sigma],
    ...
    u = T.dscalar('u')
    rff_feature_map_comp_theano = function(inputs=[x, omega, u],
                                           outputs=get_expr_rff_feature_map_component(x, omega, u))
    rff_feature_map_comp_grad_theano = function(inputs=[x, omega, u],
                                                outputs=get_expr_rff_feature_map_component_grad(x, omega, u))
    rff_feature_map_comp_hessian_theano = function(inputs=[x, omega, u],
                                                   outputs=get_expr_rff_feature_map_component_hessian(x, omega, u))
